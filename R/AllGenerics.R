...
##' Method extracts \code{tibbles} from \code{result} slots of \code{feaResult} and
##' \code{gessResult} objects. They are generated by the GESS and FEA functions defined
##' by \code{signatureSearch}, respectively.
