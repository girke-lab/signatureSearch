...
#'   
#' @seealso \code{\link{parse_gctx}}, \code{\link{read.gctx.meta}}, \code{\link{read.gctx.ids}}
...
#' @family GCTX parsing functions
#' @export
read.gctx.meta <- function(gctx_path, dimension="row", ids=NULL, set_annot_rownames=TRUE) {
...
methods::setMethod("initialize",
          signature = "GCT",
          definition = function(.Object, mat=NULL, rdesc=NULL, cdesc=NULL, src=NULL, rid=NULL, cid=NULL, set_annot_rownames=FALSE,
                                matrix_only=FALSE) {
            ...
            if (!is.null(cdesc)) {
              ...
              if (grepl(".gct$", src)) {
                ...
                if (!matrix_only) {
                  ...
                  .Object@rdesc <- data.frame(id=.Object@rid, stringsAsFactors = FALSE)
                  .Object@cdesc <- data.frame(id=.Object@cid, stringsAsFactors = FALSE)
                }
