...
the 5 FEA methods. The functional categories are ranked from top to bottom
according to mean ranks increased from lowest to largest. Since the
...
number of result methods divided by the total number of occurences of a functional category. For instance, if a functional category is only present in the
result of one method, its mean rank will be increased accordingly. 
...
<font size="-2"> Figure 4: Top 20 re-ranking GO terms in MF ontology (y-axis) 
across 5 FEA methods (x-axis). This plot shows the top 20 GO terms re-ranked by 
comparing the adjusted mean rank of each functional category across the 5 
methods. The dot represents p-value of the functional category across different 
methods. </font>
...
<font size="-2"> Figure 5: Top 20 re-ranking KEGG pathways (y-axis) across 5
FEA methods (x-axis). This plot shows the top 20 KEGG pathways re-ranked as 
Figure 4. </font>
...
deacetylase activity*. This network shows the interactions of input drugs
and gene/proteins in the selected pathway. Only those drugs that have targets 
are presented. Drugs are in square shape with orange color, 
targets are in circle shape with red color. The connection line is not weighted,
indicating yes or no. The color depth is scaled with the number of connections.
The more of the targets/drugs, the higher of the color of the drugs/targets.</font>
...
legend is the same with Figure 6.</font>
...
<font size="-2"> Figure 8: Drug-target network for *Alcoholism*. The 
legend is the same with Figure 6.</font>
...
<font size="-2"> Figure 9: Drug-target network for *Longevity regulating pathway*. 
The legend is the same with Figure 6.</font>
