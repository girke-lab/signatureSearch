...
qsig_cmap <- qSig(query = list(upset=upset, downset=downset), 
                  gess_method="CMAP", refdb=db_path, refdb_name="sample")
...
qsig_lincs <- qSig(query = list(upset=upset, downset=downset), 
                   gess_method="LINCS", refdb=db_path, refdb_name="sample")
...
qsig_gcmap <- qSig(query = query_mat, gess_method = "gCMAP", 
                   refdb = db_path, refdb_name="sample")
...
qsig_fisher <- qSig(query = query_mat, gess_method = "Fisher", 
                    refdb = db_path, refdb_name="sample")
...
```{r gess_sp, eval=TRUE}
qsig_sp <- qSig(query = query_mat, gess_method = "Cor", 
                refdb = db_path, refdb_name="sample")
...
qsig_spsub <- qSig(query = query_mat_sub, gess_method = "Cor", 
                   refdb = db_path, refdb_name="sample")
