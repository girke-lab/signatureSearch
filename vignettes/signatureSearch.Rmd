...
The CMAP and LINCS signature databases can be loaded from `signatureSearchData`
...
`data.frame` representing genome-wide GEPs of compound or genetic treatments in 
cells is provided. The GEPs can be log2 fold change, z-scores \emph{etc.} from 
differential expression analysis, or gene expression intensity values from 
Affymetrix Chips, or read counts from RNA-Seq data.
