...
The GES databases introduced above store quantitative gene expression profiles.
...
Ontology, KEGG, GeneSetDB from mouse. The following introduces how to work with
...
Gene set that do not have up or down labels
...
<p style="color:red">[ThG: the above gives errors starting at gmt2h5().]</p>
