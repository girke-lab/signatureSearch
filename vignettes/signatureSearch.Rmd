...
cell were combined to generate a sample reference database. To reduce the size
of the sample database, 5000 genes were randomly sampled from 12,328 genes.
The query signature was the vorinostat treatment drawn from the sample database.
