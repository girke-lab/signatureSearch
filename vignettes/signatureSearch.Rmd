...
set as in the above `tsea_dup\_hyperG` function call. The arguments of the
...
<font color="blue">[ThG-Comment: I suggest to change the column title "geneID"
in the result tables from the DSEA to "drugID". Or if you want to use the same
for both TSEA and DSEA, then use something like "itemID" or similar.]</font>
...
The above GESS and TSA results can be rendered as interactive drug-target
...
This project is funded by NIH grants U19AG02312 and U24AG051129 awarded by the National Institute on Aging (NIA).
