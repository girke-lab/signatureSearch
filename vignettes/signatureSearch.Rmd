...
both the query and reference database contains the same type of gene identifiers. 
...
method a more comparable amount of information than this is the case for 
correlation methods with genome-wide GESs. 
